          ...
          if (!jsFiles || jsFiles.length === 0) {
            ...
            if (injectJs) {
              ...
              compilation.assets[injectFileName] = new ConcatSource(
                injectJs,
                `(function (g) {g.setTimeout(function(){if(!g.${fnName}) var s=document.createElement("script");s.charset="utf-8",s.type="text/javascript",s.src="${publicPath ? publicPath + file_name : file_name}";g.document.body.appendChild(s);},100);})(window)`
              );
