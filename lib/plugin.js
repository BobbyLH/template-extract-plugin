        ...
        if (injectInJs) {
          ...
          if (!jsFiles || jsFiles.length === 0) {
            ...
            if (injectJs) {
              ...
              const executeJs = `if(!g.${fnName}_init_ && !g.${fnName}){g.${fnName}_init_=true;var s=document.createElement("script");s.charset="utf-8",s.type="text/javascript",s.src="${publicPath ? publicPath + file_name : file_name}";s.defer=true;s.async=false;g.document.body.appendChild(s);}`
