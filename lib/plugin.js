        ...
        if (injectInJs) {
          ...
          if (!jsFiles || jsFiles.length === 0) {
            ...
            if (injectJs) {
              ...
              const appendJs = `(function (g) {g.setTimeout(function(){if(!g.${fnName}_init_ && !g.${fnName}){g.${fnName}_init_=true;var s=document.createElement("script");s.charset="utf-8",s.type="text/javascript",s.src="${publicPath ? publicPath + file_name : file_name}";g.document.body.appendChild(s);}},0);})(window);`
              ...
              let pureHtml = pluginArgs.html.replaceAll('<!--template-extract-dom-->', '');
              pureHtml = pureHtml.replaceAll('<!--template-extract-css-->', '');
              pureHtml = pureHtml.replaceAll('<!--template-extract-js-->', '');
              pureHtml = pureHtml.replaceAll('<!--template-extract-del-start-->', '');
              pureHtml = pureHtml.replaceAll('<!--template-extract-del-end-->', '');
