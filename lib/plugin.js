        ...
        if (injectInJs) {
          ...
          if (!jsFiles || jsFiles.length === 0) {
            ...
            if (injectJs) {
              ...
              .substring(0, 8);
              const fileName = `snapshot.template.${hash}.js`

              compilation.assets[injectFileName] = new ConcatSource(
                injectJs,
                `(function (g) {g.setTimeout(function(){if(!g.${fnName}) var l=document.createElement("script");l.charset="utf-8",l.timeout=120,l.src="${publicPath ? publicPath + fileName : fileName}";g.document.body.appendChild(l);},100);})(window)`
              );
