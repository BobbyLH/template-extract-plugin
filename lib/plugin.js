        ...
        if (injectInJs) {
          ...
          if (!jsFiles || jsFiles.length === 0) {
            ...
            jsFiles.some((fileName, ind) => {
              if (~fileName.indexOf(typeof injectInJs === 'string' ? injectInJs : 'chunk') || ~fileName.indexOf('chunk') || ~fileName.indexOf('vendor') || ~fileName.indexOf('main') || ~fileName.indexOf('index')) {
                fileIndex = ind;
                return true;
              }
              return false;
